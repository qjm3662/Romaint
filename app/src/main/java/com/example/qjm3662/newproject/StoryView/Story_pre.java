...
public class Story_pre extends AppCompatActivity implements View.OnClickListener {
...
//                System.out.println(file.exists());
                if (file.exists()) {
                    ...
                    Tool.insertPic(bm, path,Story_pre.this,tv);
        ...
        switch (v.getId()){
            case R.id.read_title:
                ...
                if(JUDGE){
                    ...
                    intent.setClass(Story_pre.this, Edit_Acticity.class);
