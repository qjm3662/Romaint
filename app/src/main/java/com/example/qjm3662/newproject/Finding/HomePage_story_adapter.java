...
/**
 * Created by qjm3662 on 2016/7/3 0003.
 */
public class HomePage_story_adapter extends BaseAdapter{


    private LayoutInflater inflater = null;

    public HomePage_story_adapter(Context context) {
    ...
    @Override
    public int getCount() {
        return App.Public_HomePage_StoryList.size();
    }

    @Override
    public Object getItem(int position) {
        return App.Public_Story_User.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        StoryBean storyBean = App.Public_HomePage_StoryList.get(position);
